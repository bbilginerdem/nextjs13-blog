    ...
    <div className="container mb-5">
      <div className='row'>
        <div className='col'>
          ...
          <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} className="form-control p-2 my-2" />

          <label className="text-secondary">Blog content</label>
          <ReactQuill className='border rounded my-2' value={content} onChange={e => setContent(e)} />
          ...
          <div className='d-flex justify-content-between mt-3'>
            <button className="btn btn-outline-secondary">
              <label className='mt-2' htmlFor="upload-button" >{loading ? "Uploading..." : "Upload image"}</label>
